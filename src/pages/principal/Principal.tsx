...
export default function Principal() {
    return (
        <section className="relative bg-[#f0eff2] text-[#1a1a1a]">
            <div className="max-w-7xl mx-auto px-4 py-3 grid lg:grid-cols-2 gap-20 items-center">
                {/* Imagem principal */}
                <div className="relative order-2 lg:order-1">
                    <div className="relative w-full max-w-lg mx-auto rotate-45">
                        <img
                            src="https://ik.imagekit.io/qvv2cbqgy/Post%20Prato%20de%20Comida%20Chique%20Verde%20Escuro%20e%20Cinza%20(1).PNG?updatedAt=1755095978976"
                            alt="Foto prato"
